...
import {
  Pill, FileDown, ShoppingBag, CheckCircle2, Clock, Truck, Package,
  X, Phone, MapPin, Building2, RotateCcw, MessageSquare, AlertCircle
} from "lucide-react";
...
export default function PatientPrescriptions() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="My Prescriptions & Refills" subtitle="Digital prescriptions, pharmacy orders, and doctor refill requests." />
